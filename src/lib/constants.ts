...
export const CATS: CategoryDef[] = [
  { key: "breakfast", Icon: Croissant, label: "Breakfast" },
  { key: "lounge", Icon: Martini, label: "Lounge Access" },
  { key: "drinks", Icon: Coffee, label: "Drinks & Coffee" },
  { key: "upgrade", Icon: ArrowUpCircle, label: "Room Upgrades" },
  { key: "gift", Icon: Gift, label: "Welcome Gift" },
  { key: "late_checkout", Icon: Clock, label: "Late Checkout" },
  { key: "spa", Icon: Flower2, label: "Spa & Wellness" },
  { key: "parking", Icon: Car, label: "Parking" },
  { key: "fnb_credit", Icon: CreditCard, label: "F&B Credit" },
  { key: "housekeeping", Icon: SprayCan, label: "Housekeeping" },
  { key: "bathroom", Icon: Bath, label: "Bathroom" },
  { key: "wifi", Icon: Wifi, label: "WiFi & Internet" },
  { key: "shower", Icon: ShowerHead, label: "Shower & Water Pressure" },
  { key: "security", Icon: ShieldCheck, label: "Room Security" },
  { key: "pool", Icon: Waves, label: "Pool & Fitness" },
  { key: "staff_service", Icon: ConciergeBell, label: "Staff & Service Quality" },
  { key: "restaurant", Icon: Utensils, label: "Restaurant & Bar Hours" },
