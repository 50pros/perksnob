...
export default function ClaimUnlocks({ hotelName }: { hotelName: string }) {
  return (
    <section className="mt-14 overflow-hidden rounded-2xl bg-ink p-8 text-paper sm:p-10">
      ...
      <h2 className="mt-3 max-w-[24ch] font-display text-3xl font-semibold tracking-tight">
        Claim {hotelName} — free
      </h2>
      <p className="mt-3 max-w-prose text-paper/70">
        Claiming takes about two minutes and is verified by a one-time email to the address
        already on file. Here&rsquo;s what it unlocks:
      </p>
